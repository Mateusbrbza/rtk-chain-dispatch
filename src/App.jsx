...
import { increase, increaseAsync } from './features/countSlice';
import { toggleAsync } from './features/divisibleByFour';
...
const App = () => {
	...
	const handleClick = async () => {
		dispatch(increaseAsync())
			.then(() => dispatch(toggleAsync()))
			.then(() => console.log('done both asuync actions'))
	};
